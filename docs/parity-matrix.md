...
| Social Media             | /tabs/tab1                       | /tabs/tab1                       | in-progress       | in-progress | in-progress | done        | done         | done        | in-progress | done         | in-progress | Vertical slice scaffolded using models, service, composable, and component. See social-media-parity-notes.md. |
